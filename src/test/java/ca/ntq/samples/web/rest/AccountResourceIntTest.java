package ca.ntq.samples.web.rest;

import ca.ntq.samples.JhipsterReactSampleAppApp;
import ca.ntq.samples.config.Constants;
import ca.ntq.samples.domain.Authority;
import ca.ntq.samples.domain.User;
import ca.ntq.samples.repository.AuthorityRepository;
import ca.ntq.samples.repository.UserRepository;
import ca.ntq.samples.security.AuthoritiesConstants;
import ca.ntq.samples.service.MailService;
import ca.ntq.samples.service.UserService;
import ca.ntq.samples.service.dto.PasswordChangeDTO;
import ca.ntq.samples.service.dto.UserDTO;
import ca.ntq.samples.web.rest.errors.ExceptionTranslator;
import ca.ntq.samples.web.rest.vm.KeyAndPasswordVM;
import ca.ntq.samples.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterReactSampleAppApp.class)
