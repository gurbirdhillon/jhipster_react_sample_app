package ca.ntq.samples.repository;

import ca.ntq.samples.JhipsterReactSampleAppApp;
import ca.ntq.samples.config.Constants;
import ca.ntq.samples.config.audit.AuditEventConverter;
import ca.ntq.samples.domain.PersistentAuditEvent;
...
import static ca.ntq.samples.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
